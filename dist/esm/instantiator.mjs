...
function isPropertyRequired(property, requiredArray) {
    ...
    for (var _i = 0, requiredArray_1 = requiredArray; _i < requiredArray_1.length; _i++) {
        var requiredProperty = requiredArray_1[_i];
 ...
 * @returns {*}
 */
export function instantiate(schema, options) {
